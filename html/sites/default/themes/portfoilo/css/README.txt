...
To use these stylesheets, rename the files and portfoilo with the name of your theme.
...
portfoilo-alpha-default-narrow.css  
...
portfoilo-alpha-default-normal.css
...
portfoilo-alpha-default-wide.css
